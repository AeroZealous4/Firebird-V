...
// char *temp_str = (char *)"foo bar in this world";
char str1[] = "Hello World I am a Firebird V";
...
void red_read(void) // function to select red filter and display the count generated by the sensor on LCD. The count will be more if the color is red. The count will be very less if its blue or green.
{
	...
	strcpy(str1,"Red Pulses");
	lcd_string_EE(str1); // Display "Red Pulses" on LCD
...
void green_read(void) // function to select green filter and display the count generated by the sensor on LCD. The count will be more if the color is green. The count will be very less if its blue or red.
{
	...
	lcd_cursor(1,1);  //set the cursor on row 1, column 1
	strcpy(str1,"Green Pulses");
	lcd_string_EE(str1); // Display "Green Pulses" on LCD
...
void blue_read(void) // function to select blue filter and display the count generated by the sensor on LCD. The count will be more if the color is blue. The count will be very less if its red or green.
{
	...
	lcd_cursor(1,1);  //set the cursor on row 1, column 1
	strcpy(str1,"Blue Pulses");
	lcd_string_EE(str1); // Display "Blue Pulses" on LCD
...
//---------------------------------------------------------
unsigned long int red_read_ret(void) // function to select red filter and display the count generated by the sensor on LCD. The count will be more if the color is red. The count will be very less if its blue or green.
{
	//Red
	filter_red(); //select red filter
	pulse=0; //reset the count to 0
...
unsigned long int green_read_ret(void) // function to select green filter and display the count generated by the sensor on LCD. The count will be more if the color is green. The count will be very less if its blue or red.
{
	//Green
	filter_green(); //select green filter
	pulse=0; //reset the count to 0
...
unsigned long int blue_read_ret(void) // function to select blue filter and display the count generated by the sensor on LCD. The count will be more if the color is blue. The count will be very less if its red or green.
{
	//Blue
	filter_blue(); //select blue filter
	pulse=0; //reset the count to 0
...
{
	unsigned long int R,B,G;
	
	R = red_read_ret();
	B = blue_read_ret();
	G = green_read_ret();

	if(R > 5638 && G > 4609) //B>5858
		return 'W';	//White patch 
	if(R > B && R > G)
		return 'R';
	else if (B > R && B > G)
		return 'B';
